                  ...
                  <form onSubmit={this.formSubmit}>
                    <div className="row">
                      <div className="col-lg-4">
                        <label htmlFor="email_address">Empresas</label>
                      ...
                      <div className="col-lg-4">
                        <label htmlFor="email_address">Tipo de Transação</label>
                        <div className="form-group">
                          <div className="form-line">
                            <select
                              id="transaction_type"
                      ...
                      <div className="col-lg-4">
                        <label htmlFor="email_address">Quantia</label>
                        <div className="form-group">
                          <div className="form-line">
                            <input
                              type="text"
                    ...
                    <div className="row">
                      <div className="col-lg-4">
                        <label htmlFor="email_address">Data da Transação</label>
                        <div className="form-group">
                          <div className="form-line">
                            <input
                              type="date"
                      ...
                      <div className="col-lg-4">
                        <label htmlFor="email_address">Modo de Pagamento</label>
                        <div className="form-group">
                          <div className="form-line">
                            <input
                              type="text"
                              ...
                              name="payment_mode"
                              className="form-control"
                              placeholder="Exemplo: Dinhero, Crédito, Débito"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      {this.state.btnMessage == 0
                        ? "Adicionar transação da empresa"
                        : "Adicionando transação da empresa, aguarde."}
                    </button>
                    <br />
