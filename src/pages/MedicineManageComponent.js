            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="card">
                <div className="header">
                  ...
                  <h2>MEDICAMENTOS DISPONÍVEIS PARA ALTERAÇÃO  --  ESCOLHA UM:</h2>
                </div>
              ...
              <div className="card">
                ...
                <div className="body">
                  <form onSubmit={this.formSubmit}>
                    ...
                    <label htmlFor="email_address">Escolha aqui a Empresa:</label>
                    <div className="form-group">
                      <select
